...
const Footer = () => {
  return (
    <div>
      <div className="flex items-center flex-col md:flex-row justify-evenly h-80 md:h-64">
        <div className="bg-[#1F2937] text-white pt-5 md:pt-12 p-0 md:pl-10 text-center  w-full md:w-1/2 h-1/2 md:h-full">
          <h1 className="text-white font-medium text-2xl">CONTACT US</h1>
          <p>123 ABS Street, Uni 21, Bangladesh</p>
          <p>+88 123456789 </p>
          <p>Mon - Fri: 08:00 - 22:00 </p>
          <p> Sat - Sun: 10:00 - 23:00</p>
        </div>
        <div className="bg-[#111827] pt-6 md:pt-12 w-full md:w-1/2 pr-0 md:pr-16 h-1/2 md:h-full">
          <header className="text-center font-medium text-white text-2xl">
            Follow Us
          </header>
      ...
      <div className="footer footer-center p-2 bg-black text-white">
        <aside>
