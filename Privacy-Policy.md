...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Bistro Restaurant.
...
- **Website** refers to Bistro Restaurant, accessible from [bistro-restaurant.sh](bistro-restaurant.sh)
