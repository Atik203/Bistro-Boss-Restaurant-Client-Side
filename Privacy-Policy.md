...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Bistro Restaurant.
...
- __Website__ refers to Bistro Restaurant, accessible from [bistro-restaurant.sh](bistro-restaurant.sh)
...
- By visiting this page on our website: [bistro-restaurant.sh](bistro-restaurant.sh)